...
#[test]
fn sequence_compiles_without_panic() -> Result<(), Box<dyn std::error::Error>> {
...
#[test]
fn sequence_has_all_participants() -> Result<(), Box<dyn std::error::Error>> {
...
#[test]
fn sequence_shows_compute_rank_call() -> Result<(), Box<dyn std::error::Error>> {
    let out = compile_example()?.to_sequence_mermaid();
    assert!(
...
#[test]
fn sequence_shows_compute_rank_return() -> Result<(), Box<dyn std::error::Error>> {
    let out = compile_example()?.to_sequence_mermaid();
    assert!(
...
#[test]
fn sequence_shows_log_visit_call() -> Result<(), Box<dyn std::error::Error>> {
    let out = compile_example()?.to_sequence_mermaid();
    assert!(
...
#[test]
fn sequence_shows_log_visit_return() -> Result<(), Box<dyn std::error::Error>> {
    let out = compile_example()?.to_sequence_mermaid();
    assert!(
...
#[test]
fn sequence_shows_rank_binding() -> Result<(), Box<dyn std::error::Error>> {
    let out = compile_example()?.to_sequence_mermaid();
    assert!(
...
#[test]
fn sequence_shows_menu_as_alt_block() -> Result<(), Box<dyn std::error::Error>> {
    let out = compile_example()?.to_sequence_mermaid();
    assert!(
        out.contains("alt "),
...
#[test]
fn sequence_shows_jump_to_talk() -> Result<(), Box<dyn std::error::Error>> {
    let out = compile_example()?.to_sequence_mermaid();
    assert!(
...
#[test]
fn sequence_shows_dialogue_notes() -> Result<(), Box<dyn std::error::Error>> {
    let out = compile_example()?.to_sequence_mermaid();
    assert!(
...
#[test]
fn sequence_write_artifact_for_inspection() -> Result<(), Box<dyn std::error::Error>> {
    let out = compile_example()?.to_sequence_mermaid();
